...
process.env['SHIMMED_PRIMARIES'] +=
  ',' +
  'delegate.example.domain|http://127.0.0.1:10005|' +
  TEST_DELEGATE_DOMAIN_PATH;
...
process.env['SHIMMED_PRIMARIES'] +=
  ',' +
  util.format(
    'hozed.domain|http://127.0.0.1:10005|%s',
    path.join(__dirname, 'data', 'hozed.domain', '.well-known', 'browserid')
  );
...
process.env['SHIMMED_PRIMARIES'] +=
  ',' +
  util.format(
    'cycle.domain|http://127.0.0.1:10005|%s',
    path.join(__dirname, 'data', 'cycle.domain', '.well-known', 'browserid')
  );

process.env['SHIMMED_PRIMARIES'] +=
  ',' +
  util.format(
    'cycle2.domain|http://127.0.0.1:10005|%s',
    path.join(__dirname, 'data', 'cycle2.domain', '.well-known', 'browserid')
  );
...
process.env['SHIMMED_PRIMARIES'] +=
  ',' +
  util.format(
    'borkedauthority.domain|http://127.0.0.1:10005|%s',
    path.join(
      __dirname,
      'data',
      'borkedauthority.domain',
      '.well-known',
      'browserid'
    )
  );
