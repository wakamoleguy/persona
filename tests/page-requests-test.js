...
suite.addBatch({
  ...
  'GET /.well-known/browserid?domain=yahoo.com': respondsWith(200),
  'GET /unsupported_dialog': respondsWith(200),
  'GET /unsupported_dialog_without_watch': respondsWith(200),
  ...
  'GET /provisioning_api.orig.js': respondsWith(200),
  'GET /authentication_api.js': respondsWith(200),
  'GET /authentication_api.orig.js': respondsWith(200),
