...
var new_secondary_123done_two_browsers = {
  ...
  'verify logged in automatically to 123done in first browser': function (
    done
  ) {
    browser
      .chain({ onError: done })
...
var new_secondary_mfb_two_browsers = {
  ...
  'open verification link in second session and re-enter password': function (
    done,
    token,
    link
  ) {
  ...
  "back in the first session, back to main window and verify we're auto-logged in as the expected user": function (
    done
  ) {
    browser
      .chain({ onError: done })
...
var new_secondary_personaorg = {
  ...
  'create restmail user at persona.org and verify logged in OK': function (
    done
  ) {
    browser
      .chain({ onError: done })
  ...
  'open link, verify you are redirected to acct mgr and see your email': function (
    done,
    token,
    link
  ) {
...
runner.run(
  module,
  [
    new_secondary_123done_two_browsers,
    new_secondary_mfb_two_browsers,
