...
exports.forward = function (dest, req, res, cb) {
    ...
    .request(
      ...
      function (pres) {
        ...
        [
          ...
          if (Object.prototype.hasOwnProperty.call(pres.headers, header.toLowerCase())) {
  ...
  if (req.text && req.headers['content-length']) {
    preq.setHeader('Content-Length', Buffer.byteLength(req.text, 'utf8'));
  }
  preq.end(req.text);
