...
runner.run(
  module,
  {
    ...
    //
    'authenticate to persona for the first time with a primary email address': function (
      done
    ) {
      browser
        .chain()
    ...
    'spawn the dialog again and try to log in un-authed with address': function (
      done
    ) {
      browser
        .chain()
