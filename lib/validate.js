...
module.exports = function (params) {
  ...
  return function(req, resp, next) {
    ...
    function hasOwnProperty(o, p) {
      return (typeof o.hasOwnProperty === 'function') ? o.hasOwnProperty(p) : (o[p] !== undefined);
    }
    ...
    try {
      ...
      Object.keys(params).forEach(function(p) {
        if (params[p].required && !hasOwnProperty(reqParams, p)) throw "missing required parameter: '" + p + "'";
