...
const p3pPolicy =
  'CP="This is not a P3P policy, but Mozilla deeply cares about ' +
...
const userAgents = [
  {
    ie: false,
    ua:
      'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.3 Safari/537.36',
  },
  {
    ie: false,
    ua:
